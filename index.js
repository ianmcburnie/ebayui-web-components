class EbayUISwitch extends HTMLElement {
    ...
    set label(theLabel) {
        this._focusableElement.setAttribute('aria-labelledby', theLabel);
    }
...
window.customElements.define('ebayui-switch', EbayUISwitch);
